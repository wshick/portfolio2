...
all_extensions = ['extra', 'admonition', 'meta', 'nl2br', 'smarty', 'markdown_sub_sup', 'markdown_del_ins', 'markdown_mark', 'markdown_gfm_admonition', 'mdx_truly_sane_lists', 'mdx_wikilink_plus', 'mdx_tableau']
